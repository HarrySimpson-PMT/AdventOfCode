...
//read text file
string[] lines = System.IO.File.ReadAllLines(@"C:\Source\Repos\AdventOfCode\input\input.txt");
...
public class Day14
{
    ...
    {
        FallingSandSimulator simulator = new FallingSandSimulator(input);
        Console.WriteLine(simulator.Simulate());
        simulator.Print();
        Console.ReadLine();
    ...
    {
        FallingSandSimulator simulator = new FallingSandSimulator(input, true);
        Console.WriteLine(simulator.Simulate(true));
        simulator.Print();
        Console.ReadLine();
    ...
    public class FallingSandSimulator
    {
        ...
        public int Simulate(bool floor = false)
        {
            ...
            //count the number of spaces that are filled with sand
